...
const CHAOS = [ //todo 3 - make sure descriptions are accurate
    ...
    new Chaos( "15", "D-Day",                    "Choose a tile and for 1 round, units receive +1 on combat rolls when invading that district and receive 1WB for each friendly unit that dies" ),
    new Chaos( "16", "Dark Ages",                "For 1 round, choose 1 player who cannot research advancements" ),
    new Chaos( "17", "Defectors",                "Take 1 random unit that is not a Hero, Godhand, or Killer Robot from each player and place them in your own district as your units" ),
    new Chaos( "18", "Deserters",                "Remove 3 random enemy units from the map that are not a Hero, Godhand, or Killer Robot" ),
    ...
    new Chaos( "24", "Ditto",                    "Copy a card in the deck (not Heaven’s Gates)" ),
    ...
    //todo 3 - new Chaos( "57", "Laissez-faire",            "For 1 round, all trades must be agreed on by you" ),
    ...
    // new Chaos( "71", "Prophetic Vision",         "Skip the necessary prerequisites for an advancement" ), //todo 3 - only tech or doctrine
    ...
    //todo 3 - replace with Shut Up (and another for count of 7) - new Chaos( "80", "Setting the Agenda",       "Look at and rearrange the top five Chaos Cards" ),
